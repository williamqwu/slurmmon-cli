...
from slurmmon_cli.config import SlurmmonConfig, load_config


class TestConfigDefaults:
    def test_defaults_without_file(self, tmp_path):
        cfg = SlurmmonConfig(str(tmp_path / "nonexistent.ini"))
